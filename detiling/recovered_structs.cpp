...
typedef bool __stdcall externLoadScanline(DirectX::XMVECTOR* pDestination, size_t count, const void* pSource, size_t size, DXGI_FORMAT format); // { return true; }
externLoadScanline* ref_LoadScanline;

typedef bool __stdcall extern_LoadScanline(DirectX::XMVECTOR* pDestination, size_t count, const void* pSource, size_t size, DXGI_FORMAT format);
extern_LoadScanline* ref__LoadScanline;


typedef bool __stdcall externStoreScanline(void* pDestination, size_t size, DXGI_FORMAT format, const DirectX::XMVECTOR* pSource, size_t count, float threshold); // { return true; }
externStoreScanline* ref_StoreScanline;

typedef bool __stdcall extern_StoreScanline(void* pDestination, size_t size, DXGI_FORMAT format, const DirectX::XMVECTOR* pSource, size_t count, float threshold);
